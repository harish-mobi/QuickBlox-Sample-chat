...
public class App extends Application {
    ...
    //App credentials
    private static final String APPLICATION_ID = "95806";
    private static final String AUTH_KEY = "FdO8kYDeMeVrLMW";
    private static final String AUTH_SECRET = "vukQkmO4sjU49U-";
    private static final String ACCOUNT_KEY = "9vCDeBbASbs6B-NdrLnu";
